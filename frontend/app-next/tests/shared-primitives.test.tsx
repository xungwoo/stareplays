...
describe("shared primitives", () => {
  ...
  it("renders the cyan panel wrapper with the shared outer card styles", () => {
  ...
  it("renders the inner panel wrapper with the shared dark panel styles", () => {
  ...
  it("renders the innerStrong panel wrapper with the shared stronger dark panel styles", () => {
  ...
  it("renders the section accent bar with the shared marker styles", () => {
